    ...
    <>
      <style jsx>{`
        ...
        .tpbanner__title {
          ...
          -moz-animation: sliderTitle3 2s ease-in-out 1s forwards infinite
            alternate;
          -webkit-animation: sliderTitle3 2s ease-in-out 1s forwards infinite
            alternate;
      ...
      <section className="banner__area tpbanner-space scene tpbanner-shape-wrapper fix">
              ...
              <div className="row justify-content-center">
                <div className="col-lg-8">
                  <div className="tpbanner__content">
                    ...
                    <h1 className="tpbanner__title mb-25 pb-10">
                      LearnLogicify <br />
                      Academy
                    </h1>
                    <p>{sm_des}</p>
            ...
            <div className="tpbanner-shape d-none d-lg-block">
              {shapes_img.map((shape, index) => (
                <MouseParallaxChild
                  ...
                  factorX={0.02}
                  factorY={0.02}
                  className={`tpbanner-shape-${shape.cls}`}
                >
                  <Image
                    className="layer"
                    data-depth={shape.data_depth}
                    src={shape.img}
                    alt="theme-pure"
                  />
                </MouseParallaxChild>
          ...
          <MouseParallaxChild
            factorX={0}
            factorY={0.1}
            className="tpbanner-shape-wrappers tpbanner-shape-y scene-y"
          >
